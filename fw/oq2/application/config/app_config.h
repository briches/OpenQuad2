...
#define DEBUG_CYAN_HIGHLIGHT_SELECT     QSPI_FLASH_MODULE_ID
#define DEBUG_YELLOW_HIGHLIGHT_SELECT   FATFS_IO_MODULE_ID
...
#define FLIGHT_THREAD_PERIOD            100
#define FLIGHT_THREAD_STACK_SIZE        2048 * 4

#define NETWORK_THREAD_PRIO             osPriorityNormal1
#define NETWORK_THREAD_PERIOD           1000
#define NETWORK_THREAD_STACK_SIZE       10000 * 4

#define FILEMANAGER_THREAD_PRIO         osPriorityNormal1
#define FILEMANAGER_THREAD_PERIOD       25
#define FILEMANAGER_THREAD_STACK_SIZE   2500 * 4
